...
%%
   ...
   elseif (eg==3) 
      ...
      P0 = [];
      %filename = 'pdb6lu7.pdb'
      %filename = 'pdb2hda.pdb'
      %filename = 'pdb2hda.txt'
      %filename = 'pdb1wvn.pdb'
      %filename = 'pdb1wvn.txt'
      filename = 'pdb1GM2.txt';
      %filename = '1R9H.pdb'
      %filename = 'pbd1r9h.txt'
      %filename = 'pdb1h9r.pdb'
      %filename = 'PF00254_1R9H.pdb'
